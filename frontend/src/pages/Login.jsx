      ...
      <main className="relative z-10 w-full max-w-[480px]">
        <div className="relative overflow-hidden rounded-xl border border-outline-variant/30 bg-surface/70 p-8 shadow-2xl backdrop-blur-[20px] md:p-10">
          ...
          <div className="space-y-3">
            <button
              type="button"
              className="flex w-full items-center justify-center gap-3 rounded-lg border border-outline-variant/50 bg-transparent py-3 transition-colors hover:bg-surface-high"
            >
              <svg className="h-5 w-5 opacity-90" viewBox="0 0 24 24">
                <path
            ...
            >
              <span
                className="material-symbols text-[20px] text-accent"
                style={{ fontVariationSettings: "'FILL' 0" }}
              >
                smartphone
              </span>
          ...
          <div className="mt-6 flex flex-col items-center gap-4">
            ...
            <div className="flex items-center gap-2 rounded-full border border-outline-variant/20 bg-surface/50 px-4 py-2 text-text-muted">
              <span
                className="material-symbols text-[16px] text-accent"
                style={{ fontVariationSettings: "'FILL' 0" }}
              >
                lock
              </span>
              <span className="font-label-sm text-label-sm">
                Your discovery is protected by end-to-end encryption.
              </span>
            </div>
          </div>
        </div>
